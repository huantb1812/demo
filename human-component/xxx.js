...
$.fn.extend({
    // get human() {
    //     return 'nguyen van huan'
    // },
    hunhun: function () {
        return this.each(function () {
            this.value = 'nguyen van huan';
        });
    },
});
...
class HumanMap {
    ...
    constructor(option) {
        this.container = '';
        this.statelistSelector = `${this.container} .statelist`;
        this.conditionsSelector = `${this.container} .conditions`;
        this.userConfig = option;
    }
